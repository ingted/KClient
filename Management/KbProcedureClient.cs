...
namespace NTDLS.Katzebase.Client.Management
{
    public class KbProcedureClient
    {
        ...
        /// </summary>
        public KbQueryProcedureExecuteReply Execute(string fullyQualifiedProcedureName, KbInsensitiveDictionary<string?>? userParameters = null, TimeSpan? queryTimeout = null)
        {
        ...
        /// Executes a procedure with or without parameters. This method of calling a procedure performs various types of validation.
        /// </summary>
        public KbQueryProcedureExecuteReply Execute(string schemaName, string procedureName, KbInsensitiveDictionary<string?>? userParameters = null, TimeSpan? queryTimeout = null)
        {
            if (_client.Connection?.IsConnected != true) throw new Exception("The client is not connected.");
        ...
        /// Executes a procedure with or without parameters. This method of calling a procedure performs various types of validation.
        /// </summary>
        public IEnumerable<T> Execute<T>(string schemaName, string procedureName, KbInsensitiveDictionary<string?>? userParameters = null, TimeSpan? queryTimeout = null) where T : new()
        {
            if (_client.Connection?.IsConnected != true) throw new Exception("The client is not connected.");
        ...
        public IEnumerable<T> Execute<T>(string fullyQualifiedProcedureName,
            KbInsensitiveDictionary<string?>? userParameters = null, TimeSpan? queryTimeout = null) where T : new()
        {
            if (_client.Connection?.IsConnected != true) throw new Exception("The client is not connected.");
